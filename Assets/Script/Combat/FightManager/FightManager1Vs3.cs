...
public class FightManager1Vs3 : MonoBehaviour
{
    ...
    public GameObject enemyDisplay1;
    public GameObject enemyDisplay2;
    public GameObject enemyDisplay3;
    ...
    public static Animator enemyAnimator1;
    public static Animator enemyAnimator2;
    ...
    public void InitDisplaysEnemies()
    {
        enemyDisplay1.GetComponent<Image>().sprite = enemies[0].GetComponent<SpriteRenderer>().sprite;
        enemyDisplay2.GetComponent<Image>().sprite = enemies[1].GetComponent<SpriteRenderer>().sprite;
        enemyDisplay3.GetComponent<Image>().sprite = enemies[2].GetComponent<SpriteRenderer>().sprite;
    }
    ...
    public IEnumerator launchAnimation()
    {
        foreach (Actions action in actionsTurn)
        {
            if (action.GetEntitie() == "Player")
                ...
                enemyAnimator1.SetBool("enemyAttacking", true);
            ...
            if (action.GetEntitie() == "Player")
                ...
                if (enemyAnimator1 != null)
                enemyAnimator1.SetBool("enemyAttacking", false);
    ...
    public void InitFightManager()
    {
        ...
        //enemyAnimator1 = GameObject.Find("EnemyDisplay").GetComponent<Animator>();
